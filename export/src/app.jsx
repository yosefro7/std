...
function PhotoStack({ opened, motionStyle }) {
  ...
  const photos = [
    { src: window.__resources.chiefBw,     rot: -10, x: -72, y: -8, delay: 600,  z: 1, caption: 'Stawamus Chief' },
    { src: window.__resources.squamishWide, rot:   8, x:  68, y:  4, delay: 900,  z: 2, caption: 'The Summit' },
    { src: window.__resources.handsRing,    rot:  -2, x:   0, y: 28, delay: 1200, z: 3, caption: 'She said yes.' },
  ];
